...
public class motivationalPhraseDAOJDBC {
    ...
    public motivationalPhrase generateMotivationalPhrase (String index) throws SQLException {
        ...
        motivationalPhrase motPhrase = new motivationalPhrase(phrase) ;								//istanzio una motivationaLphrase							  									//cambio lo stato di motivationalphrase con quella nuova presa
